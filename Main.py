...
def train():
    ...
    if(opt.datasets == 'food2k'):
        tra_dataloader, te_dataloader = get_loader(opt.food2k_path)
    elif(opt.datasets == 'CNFOOD241'):
        tra_dataloader, te_dataloader = get_loader(opt.CNFOOD241_path)
    elif(opt.datasets == 'food101'):
        tra_dataloader, te_dataloader = get_loader(opt.food101_path)
    ...
    for epoch in range(opt.epochs):
        ...
        for i, (tra_transformed_normalized_img, tra_labels) in pbar:
            ...
            cls_loss.backward()     # Calculate gradients
